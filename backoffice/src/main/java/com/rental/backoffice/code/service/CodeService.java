package com.rental.backoffice.code.service;

import com.rental.backoffice.code.dto.CodeCreateRequest;
import com.rental.backoffice.code.dto.CodeGroupCreateRequest;
import com.rental.backoffice.code.dto.CodeGroupResponse;
import com.rental.backoffice.code.dto.CodeGroupSearchRequest;
import com.rental.backoffice.code.dto.CodeGroupUpdateRequest;
import com.rental.backoffice.code.dto.CodeResponse;
import com.rental.backoffice.code.dto.CodeSearchRequest;
import com.rental.backoffice.code.dto.CodeUpdateRequest;
import com.rental.domain.code.entity.Code;
import com.rental.domain.code.entity.CodeGroup;
import com.rental.domain.code.repository.CodeGroupRepository;
import com.rental.domain.code.repository.CodeRepository;
...
public class CodeService {
    ...
    /** 시스템 코드 그룹 변경 차단 — backoffice/guide/conventions/delete-defense.md allow-list 패턴. */
